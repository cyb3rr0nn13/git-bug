...
func (bugResolver) ID(_ context.Context, obj *models.LazyBug) (string, error) {
	return obj.Id().String(), nil
}

func (bugResolver) HumanID(_ context.Context, obj *models.LazyBug) (string, error) {
	return obj.Id().Human(), nil
}

func (bugResolver) Status(_ context.Context, obj *models.LazyBug) (models.Status, error) {
	return convertStatus(obj.Status())
}

func (bugResolver) Comments(_ context.Context, obj *models.LazyBug, after *string, before *string, first *int, last *int) (*models.CommentConnection, error) {
...
func (bugResolver) Operations(_ context.Context, obj *models.LazyBug, after *string, before *string, first *int, last *int) (*models.OperationConnection, error) {
	input := models.ConnectionInput{
		Before: before,
		After:  after,
		First:  first,
	...
	edger := func(op models.Operation, offset int) connections.Edge {
	...
	conMaker := func(edges []*models.OperationEdge, nodes []models.Operation, info *models.PageInfo, totalCount int) (*models.OperationConnection, error) {
...
func (bugResolver) Timeline(_ context.Context, obj *models.LazyBug, after *string, before *string, first *int, last *int) (*models.TimelineItemConnection, error) {
	input := models.ConnectionInput{
		Before: before,
		After:  after,
		First:  first,
...
func (bugResolver) Actors(_ context.Context, obj *models.LazyBug, after *string, before *string, first *int, last *int) (*models.IdentityConnection, error) {
	input := models.ConnectionInput{
		Before: before,
		After:  after,
		First:  first,
...
func (bugResolver) Participants(_ context.Context, obj *models.LazyBug, after *string, before *string, first *int, last *int) (*models.IdentityConnection, error) {
	input := models.ConnectionInput{
		Before: before,
		After:  after,
		First:  first,
