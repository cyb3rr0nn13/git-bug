...
// ModelsOperationEdgeMaker define a function that take a models.Operation and an offset and
// create an Edge.
type OperationEdgeMaker func(value models.Operation, offset int) Edge
...
func OperationCon(source []models.Operation, edgeMaker OperationEdgeMaker, conMaker OperationConMaker, input models.ConnectionInput) (*models.OperationConnection, error) {
	var nodes []models.Operation
