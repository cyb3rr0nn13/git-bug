...
//go:generate genny -in=connection_template.go -out=gen_operation.go gen "Name=Operation NodeType=models.Operation EdgeType=models.OperationEdge ConnectionType=models.OperationConnection"
